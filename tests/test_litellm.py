...
from ariadne_code.llm import LLM, LiteLLM, LLMResponse
...
class TestConfigProvider:
    ...
    def test_provider_from_env(self):
        with mock.patch.dict("os.environ", {"ARIADNE_PROVIDER": "litellm"}, clear=False):
            config = Config.from_env()
            assert config.provider == "litellm"

    def test_cli_picks_litellm_class(self):
        from ariadne_code.llm import LiteLLM
