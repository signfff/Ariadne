...
Reading a codebase burns context fast: every file read and grep hit lands in
history.  Three layers reclaim room as the window fills:

  Layer 1 (tool_snip)     - truncate verbose tool results to head + tail
  Layer 2 (summarize)     - LLM-powered summary of older turns
  Layer 3 (hard_collapse) - last resort: keep only the summary + recent turns
"""
